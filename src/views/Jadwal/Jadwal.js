...
class Jadwal extends Component {
	...
	getItem(handleSuccess) {
		Auth.fetch('http://localhost:8000/api/jadwal/', {
			method: 'GET',
			timeout: 5000
		})
			.then(response => {
		...
		Auth.fetch('http://localhost:8000/api/kategori/nama_siaran_non_utama', {
			method: 'GET',
			timeout: 5000
		})
			.then(response => {
		...
		return (
			<div className="animated fadeIn textCenter">
				...
				<Card>
					<CardHeader>
						<h4>
							<i className="fa fa-calendar " /> Jadwal
						</h4>
					</CardHeader>
